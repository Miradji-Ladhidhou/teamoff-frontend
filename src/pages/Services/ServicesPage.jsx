  ...
  return (
    <Container fluid="sm">
      ...
      <Modal show={showInfoModal} onHide={() => setShowInfoModal(false)} centered>
        <Modal.Header closeButton>
          <Modal.Title>Info services</Modal.Title>
        </Modal.Header>
        <Modal.Body>
          <ul className="mb-0">
            <li>Créez un service puis affectez vos employés.</li>
            <li>La liste affiche le minimum utile.</li>
            <li>Modifiez la politique via le bouton Modifier.</li>
          </ul>
        </Modal.Body>
        <Modal.Footer>
